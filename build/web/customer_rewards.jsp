...
<body>
  ...
  <!--   <div id="preloder">
    ...
    <div class="contact-form spad pt-2">
        <div class="container">
            <div class="row">
                <!-- <div class="col-12 py-5 text-center" style="background-color: white; height: 200px;">                              
                              <h2 class="text-success"><b>Hi Customer, </b></h2>
                              <h3 class="text-success"><b>Welcome to My Rewards</b></h3>
                </div> -->
                <div class="col-12">
                    <img src="https://jersix.com/wp-content/uploads/2020/10/Empty-pana-uai-2000x1500.png" alt=""
