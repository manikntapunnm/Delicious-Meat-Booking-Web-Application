            ...
            <div class=" col-md-12">
                <div class="card table-card">
                    <div class="card-header">
                        <h5 class="text-danger">All Partners</h5>
...
int totalRecords = 0;
 ...
 PreparedStatement statement = connection.prepareStatement("SELECT * FROM partners ORDER BY partner_id DESC LIMIT ?, ?");
...
//String companyImageBase64 = new String(Base64.getEncoder().encode(companyImageBytes));
        ...
        int id = resultSet.getInt("partner_id");
    ...
    <div class="btn-group">
        <form action="update-status_1.jsp?id=<%=id%>" method="post">
