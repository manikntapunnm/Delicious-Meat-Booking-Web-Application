...
<body>
  ...
  <!--   <div id="preloder">
   ...
   <%
    ...
    <li class="py-1">
        <a href="item.jsp?email=${sessionScope.email}&category=freshmeat" class="text-dark active">Fresh Meat</a>
    </li>
    <li class="py-1">
        <a href="item.jsp?email=${sessionScope.email}&category=chicken" class="text-dark">Chicken</a>
    </li>
    <li class="py-1">
        <a href="item.jsp?email=${sessionScope.email}&category=fish" class="text-dark">Fish</a>
    </li>
    <li class="py-1">
        <a href="item.jsp?email=${sessionScope.email}&category=mutton" class="text-dark">Mutton</a>
    </li>
   <li class="py-1">
        <a href="item.jsp?email=${sessionScope.email}&category=pork" class="text-dark">Pork</a>
    </li>
    <li class="py-1">
        <a href="item.jsp?email=${sessionScope.email}&category=crab"  class="text-dark">Crabs</a>
    </li>
    <li class="py-1">
        <a href="item.jsp?email=${sessionScope.email}&category=prawns" class="text-dark">Prawns</a>
    </li>
    
<li class="py-1">
        <a href="item.jsp?email=${sessionScope.email}&category=Beef" class="text-dark">Beef</a>
    </li>
</ul>
                            ...
                            <table>
                                ...
                                <div>
                                    <ul class="featured__item__pic__hover2 featured__item__pic2 ">
                                        <li><a href="addtowishlist.jsp?itemid=<%=itemid%>&category=<%=category1%>&email=${sessionScope.email}&discountprice=<%=discountedPrice%>&priceperkg=<%=pricePerKg%>&quantity=<%=quantityValue%>" class="button" ><i class="fa fa-heart"></i></a></li>
                                        <li><a href="overview.jsp?itemid=<%=itemid%>&category=<%=category1%>&email=${sessionScope.email}&discountprice=<%=discountedPrice%>&priceperkg=<%=pricePerKg%>&quantity=<%=quantityValue%>" class="button" >Order now</a></li>
                                        <li><a href="addtocart.jsp?itemid=<%=itemid%>&category=<%=category1%>&email=${sessionScope.email}&discountprice=<%=discountedPrice%>&priceperkg=<%=pricePerKg%>&quantity=<%=quantityValue%>" class="button"><i class="fa fa-shopping-cart"></i></a></li>
                                    </ul>
                                </div>
                                </tr>
                                <tr>
...
<input type="number" name="userquantity" class="form-control" placeholder="in Kgs" step="0.1" required>
                        </div>
