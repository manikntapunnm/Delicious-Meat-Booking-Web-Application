                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        <ul>
                            ...
                            <li><a href="customer-login.jsp"><i class="fa fa-shopping-bag"></i> <span>3</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="hero__categories">
                        ...
                        <ul>
                            <li><a href="customer-login.jsp">Fresh Meat</a></li>
                            <li><a href="customer-login.jsp">Chicken</a></li>
                            <li><a href="customer-login.jsp">Fish</a></li>
                            <li><a href="customer-login.jsp">Mutton</a></li>
                            <li><a href="customer-login.jsp">Prawns</a></li>
                            <li><a href="customer-login.jsp">Spreads</a></li>
                            <li><a href="customer-login.jsp">Combos</a></li>
                            <li><a href="customer-login.jsp">Gourmet</a></li>
                            <li><a href="customer-login.jsp">Eggs</a></li>
                            <li><a href="customer-login.jsp">Seafood</a></li>
                            <li><a href="customer-login.jsp">Beef</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-9">
                    ...
                    <div class="hero__item set-bg"
                        data-setbg="https://thumbs.dreamstime.com/z/raw-fresh-lamb-meat-leg-seasonings-gray-concrete-background-122402219.jpg">
                        <div class="hero__text">
                            <span>FRESH</span>
                            <h2>Meat <br />100% Organic</h2>
                            <p>Free Pickup and Delivery Available</p>
                            <a href="customer-login.jsp" class="primary-btn">SHOP NOW</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="categories__slider owl-carousel">
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/Meat/meat.jpg">
                            <h5><a href="customer-login.jsp">Fresh Meat</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg"
                            data-setbg="https://cdn.shopify.com/s/files/1/0250/6683/1958/products/ORpinks_HC_1_0_jpg_1000x1000.jpg?v=1617998922">
                            <h5><a href="custom er_login.jsp">Prawns</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg"
                            ...
                            <h5><a href="customer-login.jsp">Chicken</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg"
            ...
            <div class="row featured__filter">
                <div class="col-lg-3 col-md-4 col-sm-6 mix fresh-meat">
                    <div class="featured__item">
                        ...
                        <div class="featured__item__text">
                            <h6><a href="customer-login.jsp">Chicken</a></h6>
                            <h5>&#8377; 160</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mix vegetables">
                    <div class="featured__item">
                        ...
                        <div class="featured__item__text">
                            <h6><a href="customer-login.jsp">Fish</a></h6>
                            <h5>&#8377; 180</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mix oranges">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg"
                            data-setbg="https://media.istockphoto.com/photos/grilled-striploin-steak-picture-id535786572?k=20&m=535786572&s=612x612&w=0&h=WAOuIsIUQB7zVW23C6MX9y5QCyl6KLPL2eYcOcc_Qdk=">
                            <ul class="featured__item__pic__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="featured__item__text">
                            <h6><a href="customer-login.jsp">Meat</a></h6>
                            <h5>&#8377; 200</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mix fresh-meat">
                    <div class="featured__item">
                        ...
                        <div class="featured__item__text">
                            <h6><a href="customer-login.jsp">Beast Chicken</a></h6>
                            <h5>&#8377; 200</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mix vegetables">
                    <div class="featured__item">
                        ...
                        <div class="featured__item__text">
                            <h6><a href="customer-login.jsp">Prawns</a></h6>
                            <h5>&#8377; 200</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mix fastfood">
                    <div class="featured__item">
                        ...
                        <div class="featured__item__text">
                            <h6><a href="customer-login.jsp">Mutton</a></h6>
                            <h5>&#8377; 600</h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix oranges">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg"
                            data-setbg="https://image.shutterstock.com/image-photo/grilled-burger-partneritemid-meat-isolated-260nw-1518276251.jpg">
                            <ul class="featured__item__pic__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="featured__item__text">
                            <h6><a href="customer-login.jsp">Meat Box</a></h6>
                            <h5>&#8377; 300</h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix fresh-meat">
                    <div class="featured__item">
                        ...
                        <div class="featured__item__text">
                            <h6><a href="customer-login.jsp">Chicken legs</a></h6>
                            <h5>&#8377; 200</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 mix oranges">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg"
                            data-setbg="https://img.freepik.com/premium-photo/circle-serving-meat-partneritemid-pieces-isolate-white-background-ball-is-red-meat-insert-it-into-layout-with-plate-delicious-raw-pork_114160-1442.jpg?w=2000">
                            <ul class="featured__item__pic__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix fastfood">
                    <div class="featured__item">
                        ...
                        <div class="featured__item__text">
                            <h6><a href="customer-login.jsp">Mutton Roll</a></h6>
                            <h5>&#8377; 600</h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="blog__item">
                        ...
                        <div class="blog__item__text">
                            ...
                            <h5><a href="#">6 ways to prepare fast</a></h5>
                            <p>Sed quia non numquam modi tempora indunt ut labore et dolore magnam aliquam quaerat </p>
                        </div>
                    </div>
                </div>
