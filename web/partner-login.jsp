...
%>
  ...
  <!--   <div id="preloder">
    ...
    <div class="contact-form spad">
        <div class="container">
            <form action="partner-login-action.jsp" method="post">
                <div class="row">
                    <div class="col-lg-5 col-md-5 p-3" style="background-color: whitesmoke;">
                        ...
                        <h4 class="py-3">Don't have an account <a href="partner-register.jsp"
                                class="text-danger">Register</a></h4>
                    </div>
                    <div class="col-lg-7 col-md-7">
                        <img src="https://i.pinimg.com/originals/67/08/6e/67086ef78a50de09a5ce6ded5a66576f.png" alt=""
