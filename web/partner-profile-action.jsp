<%-- 
    Document   : partner-profile-action
    Created on : 19-Sept-2023, 4:20:41 pm
    Author     : manikanta
--%>
  ...
  String updateFields = "";
    ...
    if (ServletFileUpload.isMultipartContent(request)) {
        ...
        // Update data in the database
            ...
            String sql = "UPDATE partners SET " + updateFields + " WHERE email=?";
            updateValues.add(email);
            ...
            try (PreparedStatement statement = connection.prepareStatement(sql)) {
                ...
                if (rowsAffected > 0) {
                    ...
                    out.println("}).then(function() { window.location.href = 'partner_profile.jsp'; });");
                    out.println("</script>");
                } else {
