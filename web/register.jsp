  ...
  <!--   <div id="preloder">
    ...
    <div class="contact-form spad py-2">
        <div class="container ">
            ...
            <form action="#">
                <div class="row">
                    <div class="offset-2 col-lg-4 col-md-4">
                ...
                <div class="row">
                    <div class="offset-2 col-lg-4 col-md-4">
                        <input type="email" placeholder="Example@gmaiil.com">
                    </div>
                    <div class="col-lg-4 col-md-4">
                ...
                <div class="offset-3 col-lg-6 text-center">
                    <button type="submit" class="site-btn"><a href="admin-login.jsp"
                            class="text-white">Register</a></button>
                </div><br>
                <h3 class="offset-4">Already have an account ?<a href="admin-login.jsp" class="text-danger">login</a>
                </h3>
        </div>
        </form>
    </div>
