...
<head>
    ...
    <title>D-LICIOUS | Register</title>
...
%>
  ...
  <!--   <div id="preloder">
    ...
    <div class="contact-form spad py-2">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
            ...
            <form action="customer-register-action.jsp" method="post" enctype="multipart/form-data" >
                <div class="row">
                    <div class="col-2"></div>
                ...
                <div class="row">
                    <div class="col-2"></div>
                    <div class="col-lg-6">
                        <h3>Already have an account ?<a href="customer_dashboard.jsp" class="text-danger">login</a>
                        </h3>
                    </div>
                </div>
            </form>
